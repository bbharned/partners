class CreateRoiTable < ActiveRecord::Migration[6.1]
  def change
    create_table :rois do |t|
      ...
      t.decimal :labor_overhead, precision: 10, scale: 2, default: 40.00
      t.decimal :total_labor_per_year, precision: 10, scale: 2, default: 70000.00
      t.decimal :total_labor_per_hour, precision: 10, scale: 2, default: 33.65

      #PC Stats
      t.decimal :pc_ave_cost, precision: 10, scale: 2, default: 1250.00
      ...
      t.decimal :pc_percent_fail_rate, precision: 10, scale: 2, default: 10.00
      t.decimal :pc_watt_power_comsumption, precision: 10, scale: 2, default: 100.00
      t.integer :pc_month_ave_life, default: 36
      t.decimal :pc_ave_replace_time, precision: 10, scale: 2, default: 2.00

      #TC Stats
      t.decimal :tc_ave_cost, precision: 10, scale: 2, default: 750.00
      ...
      t.decimal :tc_percent_fail_rate, precision: 10, scale: 2, default: 2.00
      t.decimal :tc_watt_power_comsumption, precision: 10, scale: 2, default: 12.00
    ...
    add_column :users, :roi_signup, :boolean, default: false
  end
end
