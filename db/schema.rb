...
ActiveRecord::Schema.define(version: 2024_07_18_122738) do
  ...
  create_table "rois", force: :cascade do |t|
    ...
    t.decimal "rds_prep_time", precision: 10, scale: 2, default: "8.0"
    t.decimal "rds_monthly_maint", precision: 10, scale: 2, default: "2.0"
    t.integer "rds_sessions_number", default: 20
    t.integer "rds_inventory_count", default: 1
    t.decimal "rds_watt_power_comsumption", precision: 10, scale: 2, default: "200.0"
    t.integer "rds_month_ave_life", default: 60
    t.decimal "rds_percent_fail_rate", precision: 10, scale: 2, default: "1.0"
    t.decimal "rds_uptime", precision: 10, scale: 2, default: "24.0"
    t.decimal "rds_ave_replace_time", precision: 10, scale: 2, default: "2.0"
    t.decimal "thinmanager_cost", precision: 10, scale: 2, default: "0.0"
    t.decimal "thinmanager_redundancy", precision: 10, scale: 2, default: "0.0"
    t.decimal "thinmanager_maintenance", precision: 10, scale: 2, default: "0.0"
